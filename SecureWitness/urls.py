...
urlpatterns = patterns('',
    ...
    url(r'^SecureWitness/$', views.init, name='init'),
    ...
    url(r'^group/(?P<group_id>[0-9]+)/group_remove_report_list', views.group_remove_report_list, name='group_remove_report_list'),
    url(r'^group/(?P<group_id>[0-9]+)/group_remove_report/(?P<report_id>[0-9]+)/', views.group_remove_report, name='group_remove_report'),
    ...
    url(r'^user/manage_users/', views.manage_users, name='manage_users'),
    url(r'^user/suspend_user_list', views.suspend_user_list, name='suspend_user_list'),
    url(r'^user/suspend_user/(?P<user_id>[0-9]+)', views.suspend_user, name='suspend_user'),
    url(r'^user/activate_user-list/', views.activate_user_list, name='activate_user_list'),
    url(r'^user/activate_user/(?P<user_id>[0-9]+)', views.activate_user, name='activate_user'),
